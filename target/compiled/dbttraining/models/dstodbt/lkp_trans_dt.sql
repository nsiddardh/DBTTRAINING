...
FROM TESTDBT.DBT_SNAMBURI.lkp_busi_dt as LKP_BUSI_DT INNER JOIN TESTDBT.DBT_SNAMBURI.odbc_time_day_dim as CP_TIME_DAY_DIM ON  LKP_BUSI_DT.TRANSACTION_DATE = CP_TIME_DAY_DIM.BUSIDAYDT