...
WAITING_AREA_DURATION,TRANSACTION_TIME_LKP,TOTAL_SPEED_OF_SERVICE_DURATION,LANE_NUMBER,TBC_LANE ,  from (TESTDBT.DBT_SNAMBURI.seq_hme_detail) as src_tbl INNER JOIN (TESTDBT.DBT_SNAMBURI.odbc_time_day_dim) as lkp_tbl on BUSINESS_DATE  = BUSIDAYDT)